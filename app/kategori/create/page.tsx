...
const Create = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:8000/api/kategori', { nama, deskripsi });
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-8 px-4">
            <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden p-6">
                <h1 className="text-3xl font-semibold text-gray-800 mb-6">Tambah Kategori</h1>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="nama" className="block text-gray-700 font-medium mb-1">Nama Kategori</label>
                        <input
                            id="nama"
                            type="text"
                            value={nama}
                    ...
                    <div>
                        <label htmlFor="quantity" className="block text-gray-700 font-medium mb-1">Deskripsi</label>
                        <input
                            id="deskripsi"
                            type="text"
                            value={deskripsi}
